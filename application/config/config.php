...
if(is_cli()){
    ...
    $config['base_url'] =  $protocol.$host."/mini-inventory-management-system/";
}

else{
    $allowed = ['www.1410inc.xyz', '1410inc.xyz'];//input all allowed urls here e.g. amirsanni.com, www.practa.ng, smartagapp.com

    $config['base_url'] = in_array($host, $allowed) ? $protocol.$host."/mini-inventory-management-system/" : "http://".$_SERVER['HTTP_HOST']."/";
}
